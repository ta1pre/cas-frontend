// src/app/p/cast/cont/reserve/components/Message/MessagePanel.tsx
"use client";
...
export default function MessagePanel({ isOpen, onClose, reservationId }: Props) {
  ...
  return (
    <motion.div
      ...
      className="fixed bottom-0 right-0 w-9/10 h-4/5 bg-white shadow-lg z-50 flex flex-col rounded-t-lg"
    >
      {/* ヘッダー部分（クリックで閉じる） */}
      <div onClick={(e) => { 
